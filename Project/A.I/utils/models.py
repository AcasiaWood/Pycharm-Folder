...
class nkModel(object):
    def __init__(self, args, train_loader, val_loader, test_loader):
        ...
        self.criterion = nn.CrossEntropyLoss().cube()
        self.lr = args.lr
        self.model_name = "nk"
        ...
        print("The number of parameters of models: ", num_params)
    ...
    def save_checkpoint(self, i, state, is_best):
        ...
        if is_best:
            ...
            shutil.copyfile(ckpt_path, os.path.join(self.save_dir, filename))
